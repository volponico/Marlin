...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE 126 // (0-255) Active speed, used when any motor is enabled
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_LOAD_UNLOAD_GCODES           //AICI  Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      940 //AICI Hemera 940
    #define E0_MICROSTEPS    16
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define SPI_ENDSTOPS              //AICI  // TMC2130 only
   ...
   */
  //#define SQUARE_WAVE_STEPPING //AICI
